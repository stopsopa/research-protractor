...
// g(most popular screen resolution 2017)
// const width     = 1920;
// const height    = 1080;
...
module.exports = (async function example() {
    ...
    try {
        driver = await new Builder()
            .usingServer('http://localhost:5555/wd/hub') //  to check go to : http://localhost:4444/grid/console?config=true&configDebug=true&refresh=10
